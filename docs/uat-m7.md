...
| 3   | Pick any care home, enter PLZ **13187**                                                                                         | Berlin questionnaire starts; progress shows **"0 von 53 Fragen beantwortet"** (53 since go-live round 2 made the Betreuer question required; simulation-verified 2026-08-13); the **"Fragen \| Dokumente" tabs** are visible immediately, Dokumente carrying a count badge (feedback pass: checklist from first login) |
| 4   | Answer through; at Familienstand pick **verheiratet**                                                                           | Progress denominator grows to **92** (spouse section appears; 92 = 53 + 39 spouse questions, simulation-verified 2026-08-13 after the Betreuer flip); switching to Dokumente now also shows "Unterlagen Ihres Partners" slots — they appear live, before completion                                                    |
...
| #   | Step                                                                          | What you should see                                                                                                                                                                                                                                                                                                                                                                 |
| --- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Fresh signup, care home, PLZ **66606** (St. Wendel — no questionnaire mapped) | Berlin questionnaire loads and is answerable, **"0 von 53 Fragen"** (53 since the go-live-round-2 Betreuer flip), **no questionnaire warning** (silent fallback is by design; the fallback-notice banner shown 2026-08-09 – 2026-08 was removed by the fallback-docs fix — the tab now shows the purged default checklist with no caveat); Dokumente tab present (default rule set) |
