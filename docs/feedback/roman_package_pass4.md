# Paket 2 für Roman — Content-Runde 4 (Stand 01.08.2026)
...
1. **§1 — Formulierungs-Regel („Sie" = die pflegebedürftige Person):** die
   betroffenen Fragen mit unseren Textvorschlägen → **bitte freigeben oder
   umformulieren**.
2. **§2 — Partner-Abschnitt (Essen), Vorher/Nachher** wie von dir gewünscht →
   **bitte freigeben oder umformulieren**.
...
## §1 Formulierungs-Regel: „Sie/Ihr im Fragebogen meint die pflegebedürftige Person"

Wir haben beide Fragebögen vollständig durchgeprüft (413 Fragen).
Ergebnis:

- **Essen: 0 Verstöße** — durchgehend in der 2. Person, so wie deine Regel
  es will.
- **Berlin: genau 5 Fragen**, davon erledigen sich 2 von selbst durch den
  beschlossenen Renten-Umbau (die alte Ja/Nein-Rentenfrage und das einzelne
  Betragsfeld werden ohnehin stillgelegt).

Die drei verbleibenden Fragen, mit unserem Textvorschlag (angelehnt an die
Essener Formulierungen, die du bereits kennst):

| Frage (heute live)                        | **Vorschlag** (noch nicht freigegeben) |
| ----------------------------------------- | -------------------------------------- |
| Vorname der pflegebedürftigen Person      | Wie lautet Ihr Vorname?                |
| Nachname der pflegebedürftigen Person     | Wie lautet Ihr Nachname?               |
| Geburtsdatum der pflegebedürftigen Person | Wann wurden Sie geboren?               |

Nicht geändert wird (bewusst, weil regelkonform): die Abschnitts-Überschrift
„Angaben zur pflegebedürftigen Person" und der gelbe/grüne Hinweiskasten am
Anfang — beide **erklären** deine Regel, statt sie zu verletzen. Auch alle
„Ihr Partner"-Formulierungen bleiben (gemeint ist der Partner der
pflegebedürftigen Person — genau deine Regel).

**→ Bitte: die drei Vorschläge freigeben oder deine Formulierung nennen.**

---

## §2 Partner-Abschnitt (Essen) — Vorher/Nachher

Du wolltest Beispiele sehen, bevor du entscheidest. Es geht um die vier
Einleitungsfragen der Partner-Ankreuzblöcke. Drei davon nennen den Partner
gar nicht — mitten im Partner-Abschnitt klingen sie dadurch so, als ginge es
wieder um die pflegebedürftige Person selbst. Zum Vergleich steht daneben
die Formulierung, die dieselbe Frage bei der pflegebedürftigen Person hat.

| Heute live (Partner)                                                               | Gleiche Frage bei der pflegebedürftigen Person                               | **Vorschlag Partner-Version** (noch nicht freigegeben)                                                                                                                                          |
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Trifft eine dieser seltenen Situationen auf Ihren Partner zu?                      | Trifft eine dieser seltenen Situationen auf Sie zu?                          | — passt bereits, keine Änderung                                                                                                                                                                 |
| Treffen eine oder mehrere dieser besonderen Einkommens- oder Rentensituationen zu? | Trifft eine dieser besonderen Einkommens- oder Rentensituationen auf Sie zu? | Trifft eine dieser besonderen Einkommens- oder Rentensituationen auf Ihren Partner zu?                                                                                                          |
| Gibt es eine oder mehrere dieser absetzbaren Ausgaben?                             | Haben Sie eine dieser Ausgaben?                                              | Hat Ihr Partner eine dieser Ausgaben? _(Hinweis: das Wort „absetzbaren" fällt dabei weg — die Version für die pflegebedürftige Person hat es auch nicht. Sag Bescheid, falls es bleiben soll.)_ |
| Gibt es eine oder mehrere dieser besonderen Vermögensarten?                        | Haben Sie eine dieser besonderen Vermögensarten?                             | Hat Ihr Partner eine dieser besonderen Vermögensarten?                                                                                                                                          |

Die Antwortmöglichkeiten darunter („Der Partner …") sind bereits einheitlich
und bleiben unverändert.

Der Vollständigkeit halber: Einzelne Folgefragen im Partner-Abschnitt nennen
den Partner ebenfalls nicht (z. B. „Welches Aktenzeichen steht auf dem
Bescheid?", „Welches Modell ist das Auto?"). Sie stehen aber immer direkt
unter einer Frage, die den Partner nennt, und lesen sich im Zusammenhang
eindeutig — wir empfehlen: **so lassen**. Nur falls dich eine stört, sag
Bescheid.

Beschlossen und hier nur festgehalten: Die Berliner
Partner-Versicherungsfragen bleiben wie sie sind (deine Entscheidung, keine
Angleichung an die Essener Detailtiefe).

**→ Bitte: die drei Vorschläge freigeben oder deine Formulierung nennen.**

---

## §3 Neue Fragen-Reihenfolge Berlin — zur Kenntnis

Umsetzung deiner Block-Vorgabe: **erst die PLZ des letzten Wohnortes** (das
ist bei uns der Schritt vor dem Fragebogen und bleibt ganz vorne), **dann
die persönlichen Fragen, dann Wohnung und Heim / Einkommen / Vermögen /
Versicherung-Pflege / Partner-Familie-Unterhalt.** Deine drei konkreten
Kritikpunkte aus Runde 3 sind damit behoben:

1. Das Thema „frühere Wohnung" ist nicht mehr dreigeteilt — alles zu Wohnung
   und Heim steht jetzt in einem Block (inkl. Einzugsdatum ins Pflegeheim,
   Adresse der letzten Wohnung, Mietfragen).
2. Rente wird nur noch **einmal** erhoben: „Wie viele Renten oder Pensionen
   bekommen Sie?" und dann pro Rente die vier Detailfragen — die alte
   Doppelabfrage entfällt (dein Beschluss, wird gerade gebaut).
3. Betreuung/Vollmacht steht nicht mehr zwischen Sozialhilfe-Historie und
   Ausweisen — jetzt: erst Ausweise, dann Betreuung, dann die
   Sozialhilfe-Historie am Blockende.

**Eine Frage an dich — die Abschnitts-Überschriften:** Durch die neuen
Blöcke braucht die App drei neue sichtbare Abschnittstitel. Wir würden deine
Block-Namen wörtlich übernehmen: **„Wohnung und Heim"**, **„Einkommen"**,
**„Versicherung und Pflege"** (und für den letzten Block: **„Partner,
Familie und Unterhalt"**). Passt das so als Überschrift im Fragebogen, oder
willst du andere Worte?

Vier kleine Einordnungen, die du nur abnicken (oder ändern) musst:

- Der **Bestattungsvorsorgevertrag** steht jetzt im Block „Versicherung und
  Pflege" (passend zu deiner Dokumenten-Zuordnung). Alternative: bei
  „Vermögen" lassen.
- Im letzten Block kommt **erst der Partner, dann die Kinder** (wie dein
  Block-Name „Partner-Familie-Unterhalt"). Bei Alleinstehenden beginnt der
  Block automatisch mit den Kindern, weil die Partnerfragen dann gar nicht
  erscheinen.
- Die Einzelfrage zur **kostenaufwändigen Ernährung** („Weitere Angaben")
  steht direkt vor dem Partner/Familie-Block — wie in Essen.
- **Essen selbst ändern wir nicht.** Zur Kenntnis: Gemessen an deiner
  Block-Regel stünden dort Kinder/Unterhalt sehr früh (Position 2) und die
  Krankenversicherungsfragen mitten im Einkommensteil — beides kommt so aus
  deiner Master-Datei. Wenn du das irgendwann angleichen willst, sag
  Bescheid; von uns aus passiert dort nichts.

Die vollständige neue Reihenfolge (167 Fragen; „Bisher" = Position in der
heutigen Live-Reihenfolge, „—" = neue Frage):

**Block 1 — Persönliches (Angaben zur pflegebedürftigen Person)**

| Neu | Bisher | Frage-Key                           | Frage                                                                  |
| --- | ------ | ----------------------------------- | ---------------------------------------------------------------------- |
...
| Neu | Bisher | Frage-Key             | Frage                                                                |
| --- | ------ | --------------------- | -------------------------------------------------------------------- |
| 39  | —      | `pension_count`       | NEU (D15): „Wie viele Renten oder Pensionen bekommen Sie?"           |
...
_Zur Erinnerung, bereits erledigt bzw. in Arbeit aus deinen Entscheidungen:
die zwei neuen Bestätigungstexte (alle Fragen beantwortet / in Prüfung), die
drei „Nächste Schritte", der Dokumentenbereich ab dem ersten Login mit
deinem Hinweistext, Geburtsname in Essen optional, die Ordner-Zuordnung, der
Zusatz „(letzte 4 Monate)" bei den Kontoauszügen, deine Kontaktkarte
(Foto reichst du nach). Das Logo warten wir in Originalauflösung ab — die
WhatsApp-Vorschaubilder sind für die App leider zu klein._
